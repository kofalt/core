...
def placeholders_for_collections():
    ...
    COLLECTIONS_PREFIXES = [("projects", "files"), ("acquisitions", "files"), ("analyses", "files"), ("sessions", "files"), ("sessions", "subject.files"), ("collections", "files")]
    ...
    for collection, prefix in COLLECTIONS_PREFIXES:
        ...
        for document in cursor:
            for f in get_files_by_prefix(document, prefix):
                f_dict = {"collection_id": document.get("_id"), "collection": collection, "fileinfo": f, "prefix": prefix}
