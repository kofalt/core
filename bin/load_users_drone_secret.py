...
logging.basicConfig(format="%(asctime)s %(levelname)8.8s %(message)s", datefmt="%Y-%m-%d %H:%M:%S", level=logging.DEBUG)
...
http_headers = {"X-SciTran-Method": "bootstrapper", "X-SciTran-Name": "Bootstrapper"}
if args.secret:
