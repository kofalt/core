...
def confirm_schema_match():
    ...
    if not isinstance(db_version, int) or db_version > CURRENT_DATABASE_VERSION:
        ...
        sys.exit(42)
    elif get_available_checks(applied_checks):
        sys.exit(42)
    else:
        sys.exit(0)
...
def update_file_classifications_to_66(container, container_name):
...
def upgrade_to_66():
    ...
    for container_name in container_names:
        ...
        process_cursor(cursor, update_file_classifications_to_66, container_name)
...
def upgrade_schema(force_from = None):
    ...
    try:
        ...
        # Finally run any available checks
