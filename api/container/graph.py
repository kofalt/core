...
GRAPH = {
    ...
    'analyses': {
        'connections': {
            ...
            'session': {
                'local': 'parents.session',
                'foreign': '_id',
                'collection': 'sessions',
                'order': '1'
            },
            'acquisition': {
                'local': 'parents.acquisition',
                'foreign': '_id',
                'collection': 'acquisitions',
                'order': '1'
            },
            'jobs': {
                'foreign': 'parents.analyses',
            }
        }
    },
    'jobs': {
