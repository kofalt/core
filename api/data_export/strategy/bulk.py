    ...
    def identify_targets(self, spec, uid, summary):
        ...
        for fref in spec.get('files', []):
            ...
            if src_path:  # silently skip missing files
                ...
                yield models.DownloadTarget('file', dst_path, cont_name, cont_id, file_obj['modified'], file_obj['size'],
                        file_obj.get('type'), file_id=file_obj.get('_id'), src_path=src_path)
            else:
