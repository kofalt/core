...
def log_user_access(request, access_type, cont_name=None, cont_id=None, filename=None, origin=None, download_ticket=None, job_id=None):
...
def create_entry(request, access_type, origin, context=None):
    ...
    result = {"access_type": access_type.value, "request_method": request.method, "request_path": request.path, "ip": request.client_addr, "origin": origin, "timestamp": datetime.datetime.utcnow()}
