...
class GearContextTestCases(SdkTestCase):
    ...
    def testWriteMetadata(self):
        ...
        assert metadata == {"session": {"dict_key": "dict_value", "key": "value"}, "acquisition": {"another_key": 3, "files": [{"name": "output.txt", "k": "v3", "k2": "v2"}]}}


INVOCATION = {
    "config": {"speed": 2, "coordinates": [1, 2, 3]},
    "inputs": {
        "text": {"base": "file", "hierarchy": {"type": "acquisition", "id": "5988d38b3b49ee001bde0853"}, "location": {"name": "example.txt"}, "object": {"info": {}, "mimetype": "text/plain", "tags": [], "measurements": [], "type": "text", "modality": None, "size": 12}},
        "matlab_license_code": {"base": "context", "found": True, "value": "ABC"},
        "an_api_key": {"base": "api-key", "key": get_api_key()},
    },
    "destination": {"type": "acquisition", "id": "example_id"},
}
