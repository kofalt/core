...
def containers(data_builder, as_admin, file_form, api_db):
    ...
    an_1_1_1 = as_admin.post("/sessions/" + s_1_1 + "/analyses", files=file_form("analysis.csv", meta={"label": "no-job", "inputs": [{"name": "analysis.csv"}]})).json()["_id"]
    ...
    containers = attrdict.AttrDict(p_1=p_1, s_1_1=s_1_1, c_1_1_1=c_1_1_1, an_1_1_1=an_1_1_1, ac_1_1_1=ac_1_1_1, ac_1_1_2=ac_1_1_2, s_1_2=s_1_2, ac_1_2_1=ac_1_2_1, p_2=p_2, s_2_1=s_2_1, ac_2_1_1=ac_2_1_1)

    def is_deleted(cont_key, filename=None):
        cont_name = {"p": "projects", "s": "sessions", "ac": "acquisitions", "an": "analyses", "c": "collections"}[cont_key.split("_")[0]]
