def test_search_status(as_drone, as_user, as_public):
    ...
    as_mongoconnector_drone.headers.update({"X-SciTran-Method": "service-reporting", "X-SciTran-Name": "mongo-connector"})
    ...
    as_drone.headers.update({"X-SciTran-Method": "bootstrapper", "X-SciTran-Name": "Bootstrapper"})
