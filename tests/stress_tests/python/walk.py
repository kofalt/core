                ...
                if random.random() < FILE_PERCENT:
                    ...
                    try:
                        ...
                        if len(data) != file_entry['size']:
                            validator.report_error(container, file_entry['name'], 
                                'Invalid file size reported', container_type=container_type)
                        ...
                        if hash_str:
                            ...
                            if digest != checksum:
                                validator.report_error(container, file_entry['name'],
                                    'Checksum mismatch reported', container_type=container_type)

                    except ApiException as e:
                        validator.report_error(container, file_entry['name'],
                                'Error downloading file: {} {}'.format(e.status, e.reason), container_type=container_type)
