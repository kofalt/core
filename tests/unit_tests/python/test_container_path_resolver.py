...
def test_container_path_resolver_path_prefix():
    ...
    containers = {"group": {"_id": "group_1", "label": "group_1"}, "project": {"_id": project_id, "label": "project_1"}, "subject": {"_id": subject_id, "label": "1001"}}
...
def test_container_path_resolver_analyses():
    ...
    containers = {"group": {"_id": "group_1", "label": "group_1"}, "project": {"_id": project_id, "label": "project_1"}, "subject": {"_id": subject_id, "label": "1001"}, "analysis": {"_id": analysis_id, "label": "analysis_label", "parent": {"type": "project", "id": project_id}}}
...
def test_container_path_resolver_prefix_containers():
    ...
    containers = {
        "project": {"_id": project_id, "label": "project_1"},
        "subject": {"_id": subject_id, "label": "1001"},
        "session": {"_id": session_id, "label": "ses-01"},
        "acquisition": {"_id": acquisition_id, "label": "SCAN"},
        "analysis": {"_id": analysis_id, "label": "AFQ 2018-01-13", "parent": {"type": "project", "id": project_id}},
    }
    ...
    resolver = ContainerPathResolver(include_group=False, prefix_containers=True)
    path = resolver.get_path(containers, "analysis", analysis_id)
    assert path == ("project_1", "SUBJECTS", "1001", "SESSIONS", "ses-01", "ACQUISITIONS", "SCAN", "ANALYSES", "AFQ 2018-01-13")
