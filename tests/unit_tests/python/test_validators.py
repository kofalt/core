...
IGNORED_SCHEMAS = ["input/container.json", "input/enginemetadata.json", "input/search.json", "output/sites-list.json"]  # TODO: Needs an example, is the schema really up to date?  # TODO: Is this used?  # TODO: Is this used?
...
def test_payload():
    payload = {"files": [], "group": "unknown", "label": "SciTran/Testing", "public": False, "permissions": [], "extra_params": "testtest"}
...
def test_jsonschema_validate_enum_with_null():
    schema = {"oneOf": [{"type": "null"}, {"type": "string", "enum": ["true", "false"]}]}
