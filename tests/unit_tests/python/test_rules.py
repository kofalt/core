...
class rulePart:
    ...
    def gen(self, match_type=None, match_param=None, file_=None, container=None, regex=None):
        ...
        return (match_type if match_type is not None else self.match_type, match_param if match_param is not None else self.match_param, file_ if file_ is not None else self.file_, container if container is not None else self.container, regex if regex is not None else self.regex)
...
def test_eval_match_container_has_type():
    part = rulePart(match_type="container.has-type", container={"files": [{"type": "diffusion"}, {"type": "other"}]})
...
def test_eval_match_container_has_type_regex():
    part = rulePart(match_type="container.has-type", regex=True, container={"files": [{"type": "diffusion"}, {"type": "other"}]})
...
def test_eval_rule_any():
    ...
    rule_doc = {"project_id": "000000000000000000000000", "name": "test_eval_rule_any", "any": [{"type": "file.type", "value": "dicom"}, {"type": "file.name", "value": "*.dcm"}], "all": [], "not": [], "gear_id": "000000000000000000000000"}
...
def test_eval_rule_all():
    ...
    rule_doc = {"project_id": "000000000000000000000000", "name": "test_eval_rule_any", "any": [], "not": [], "all": [{"type": "file.type", "value": "dicom"}, {"type": "file.name", "value": "*.dcm"}], "gear_id": "000000000000000000000000"}
    rule = models.Rule.from_dict(rule_doc)
...
def test_eval_rule_not():
    ...
    rule_doc = {
        ...
        "not": [{"type": "file.classification", "value": "non-image"}, {"type": "file.name", "value": "*.dcm"}, {"type": "file.classification", "value": "functional"}],
        "all": [],
        "any": [],
...
def test_eval_rule_any_all_not():
    ...
    rule_doc = {
        "project_id": "000000000000000000000000",
        "name": "test_eval_rule_any",
        "any": [{"type": "file.type", "value": "dicom"}, {"type": "file.name", "value": "*.dcm"}],
        "all": [{"type": "file.type", "value": "dicom"}, {"type": "file.name", "value": "*.dcm"}],
        "not": [{"type": "file.classification", "value": "non-image"}],
        "gear_id": "000000000000000000000000",
    }
    rule = models.Rule.from_dict(rule_doc)
...
def test_rules_mapper_insert_copy_rule(api_db):
    ...
    copy_rule_mongo_document = api_db.project_rules.find_one({"_id": copy_rule_id})
...
def test_rules_mapper_get_rule(api_db):
    # Add rules to db
    rule_1_id = api_db.project_rules.insert_one({"gear_id": "gear_id", "name": "rule_name", "any": [], "all": [], "not": [], "project_id": "site"}).inserted_id
    rule_2_id = api_db.project_rules.insert_one({"gear_id": "gear_id", "name": "rule_name", "any": [], "all": [], "not": [], "project_id": "project_id"}).inserted_id
...
def test_rules_mapper_get_rule(api_db):
    # Add rules to db
    rule_1_id = api_db.project_rules.insert_one({"gear_id": "gear_id", "name": "rule_name", "any": [], "not": None, "project_id": "site"}).inserted_id
...
def test_rules_mapper_get_rule_projection(api_db):
    # Add rules to db
    rule_id = api_db.project_rules.insert_one({"gear_id": "gear_id", "name": "rule_name", "any": [], "all": [], "not": [], "config": {"key": "value"}, "project_id": "site"}).inserted_id
...
def test_rules_mapper_find_all(api_db):
    ...
    rule_1_id = api_db.project_rules.insert_one({"gear_id": "gear_id", "name": "rule_name", "any": [], "all": [], "not": [], "project_id": "site"}).inserted_id
    rule_2_id = api_db.project_rules.insert_one({"gear_id": "gear_id", "name": "rule_name", "any": [], "all": [], "not": [], "project_id": "project_id"}).inserted_id
    rule_3_id = api_db.project_rules.insert_one({"gear_id": "gear_id", "name": "rule_name", "any": [], "all": [], "not": [], "project_id": "project_id"}).inserted_id
...
def test_rules_mapper_patch_rule(api_db):
    # Add rules to db
    rule_doc = {"gear_id": "gear_id", "name": "rule_name", "any": [], "all": [], "not": [], "config": {"key": "value"}, "project_id": "site"}
